...
\begin{document}
    ...
    \begin{framedthm}{Augmenting paths}
    ...
    This theorem can be leveraged in order to design an \tit{iterative algorithm} which can find a \tit{maximum matching} on a given bipartite graph.
