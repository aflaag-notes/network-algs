...
\begin{document}
    ...
    The problem of finding a \tbf{minimum bandwidth labeling} has been introduced in 1991 by \textcite{shao}, in the context of a frequency assignment problem, for the case of $h = 2$ and $k = 1$.
