...
\begin{document}
    ...
    Thanks to this lemma, in 1965 \textcite{edmonds} designed an algorithm, also known as \href{https://en.wikipedia.org/wiki/Blossom_algorithm}{Blossom algorithm}, and the idea of the algorithm is the following:
    ...
    The complexity of the algorithm \todo{pag 90}
