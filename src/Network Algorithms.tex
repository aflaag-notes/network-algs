...
\begin{document}
    ...
    Note that every perfect matching is a \tit{maximum matching}. Additionally, note that a perfect matching exists only if the number of vertices of $G$ is even, since each edge of the perfect matching covers exactly 2 vertices.
