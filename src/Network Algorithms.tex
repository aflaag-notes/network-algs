    ...
    \begin{framedalgo}{2-approximation TSP}
        ...
        \begin{algorithmic}[1]
            \Function{2approxTSP}{$G$, $w$}
                ...
                \State $T := \texttt{findMST}(r)$ \Comment{find an MST rooted in $r$}
